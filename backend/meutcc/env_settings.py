...
AUTH_FRONTEND_URL=getenv("AUTH_FRONTEND_URL", "${FRONTEND_URL}/auth?token={token}&data={data}")
AUTH_ERROR_FRONTEND_URL=getenv("AUTH_ERROR_FRONTEND_URL", "${FRONTEND_URL}/auth")
